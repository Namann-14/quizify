...
export default function HeroSection() {
  return (
    <motion.div
      className="flex flex-col items-center justify-center py-16 text-neutral-900 dark:text-neutral-100"
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <Link href="/signup">
          <Button className="mt-8 h-18 w-60 text-2xl">Get Started</Button>
        </Link>
      </motion.div>
